...
export function LevelPickerPopover({
    ...
    const unlockedLevels = type.levels.filter(
                ...
                <div className="grid grid-cols-4 gap-1.5">
                    {unlockedLevels.map((level) => (
                        <button
                            ...
                            className="flex flex-col items-center gap-1 rounded-lg border border-border/60 p-1.5 hover:border-primary"
                        >
                            <img
                                src={gameAssetUrl(level.file_path)}
                                alt=""
                                loading="lazy"
